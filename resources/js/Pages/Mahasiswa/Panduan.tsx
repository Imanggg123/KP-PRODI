      ...
      <div className="max-w-[1280px] mx-auto space-y-8">
        ...
        <section className="bg-primary rounded-2xl p-8 md:p-12 text-white text-center space-y-4 relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="mt-6">
              <button className="inline-block bg-white text-primary px-8 py-4 rounded-xl font-label-md hover:scale-105 transition-transform font-bold">
                Daftar Kerja Praktik Sekarang
              </button>
            </div>
          </div>
        </section>
